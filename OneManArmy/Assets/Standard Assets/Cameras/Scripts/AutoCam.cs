...
namespace UnityStandardAssets.Cameras
{
    ...
    public class AutoCam : PivotBasedCameraRig
    {
        ...
        protected override void FollowTarget(float deltaTime)
        {
            ...
            transform.position = Vector3.Lerp(transform.position, m_Target.position + new Vector3(0.0f,5.0f,0f), deltaTime*m_MoveSpeed);
            ...
            transform.rotation = Quaternion.Euler(54.0f,0.0f,0.0f);//Quaternion.Lerp(transform.rotation, rollRotation, m_TurnSpeed*m_CurrentTurnAmount*deltaTime);
        }
    }
}
